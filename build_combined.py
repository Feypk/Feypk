...
OUT="/home/user/Feypk/Plan_RU_Econ_Quant_v12.xlsx"
...
PLAN=[
 ...
 ("ปีที่ 3 / เทอม 2",[("ECO3122","เศรษฐศาสตร์มหภาคระดับสูง",3,8,"เชี่ยวชาญ","ECO2124,2125","✓","econ"),("ECO3323","การบริหารความเสี่ยงองค์กร",3,5,"เลือกกลุ่มอื่น–การเงิน","ECO2121","✓","fin"),("ECO2128","ระเบียบวิธีวิจัยทางเศรษฐศาสตร์",3,5,"แกน • ต่อยอด research paper","ECO2123-2126","✓","econ"),("MTH4404","Introduction to Real Analysis 1",3,9,"เก็บเพิ่ม • สัญญาณ #1","MTH2104","✓","quant"),("ACC4209","Financial Reporting & Analysis",3,6,"วิเคราะห์งบ (core IB)","ACC2202","✓","fin"),("SDM2102","Foundations of Python Programming",3,4,"เก็บเพิ่ม • Python","-","✓","quant"),("RAM1312","Contemporary Culture & Digital Disruption",3,2,"⬅ ย้ายมา v10 • ลดโหลด","-","✓","gen")]),
 ("ปีที่ 4 / เทอม 1",[("ECO4124","Time-Series Econometrics",3,8,"เชี่ยวชาญ (เลือก)","ECO3123","✓","econ"),("ECO4125","Microeconometrics",3,8,"เชี่ยวชาญ • เช็ก causal inf.","ECO3123","✓","econ"),("ECO4326","Mathematical Finance",3,8,"เลือกกลุ่มอื่น–การเงิน","ECO3323","✓","fin"),("MTH3611","Mathematical Stochastic Models",3,8,"เก็บเพิ่ม • Stochastic","STA2003","✓ แก้แล้ว: PR=STA2003 (อยู่ปี2/เทอม1)","quant"),("FIN3211","Financial Management (Corp Finance)",3,6,"เก็บเพิ่ม • เนื้อ IB","FIN2101","⚠️ อาจต้อง FIN3208","fin"),("RAM1204","Mathematics & Statistics for Daily Life",3,3,"⬅ ย้ายมา v9","-","✓","gen"),("RAM1302","Politics and Law in Daily Life",3,2,"ศึกษาทั่วไป 1.3","-","✓","gen")]),
 ("ปีที่ 4 / เทอม 2",[("ECO4123","Game Theory (ทฤษฎีเกม)",3,7,"เชี่ยวชาญ (เลือก)","ECO2123,2125","✓","econ"),("ECO4327","Financial Risk Mgmt & Derivatives",3,7,"เลือกกลุ่มอื่น–การเงิน","ECO3320,3323","✓","fin"),("RAM1112","ภาษาและวัฒนธรรมอังกฤษ",3,2,"⬅ ย้ายมา v12 • ศึกษาทั่วไป 1.1","-","✓","gen"),("FIN3209","Securities Analysis",3,6,"เก็บเพิ่ม • valuation","FIN2101","✓","fin"),("FIN3205","Principles & Policies of Investment",3,5,"เก็บเพิ่ม • การลงทุน","FIN2101","✓","fin"),("RAM1211","Principles of Entrepreneurship",3,2,"ศึกษาทั่วไป 1.2","-","✓","gen"),("STA4101","Theory of Statistics 1",3,9,"★ Math Stats (MFE core)","STA3102","⬅ ย้ายจากปี3/ท2","quant")]),
]
...
ws.merge_cells("A1:H1"); c=ws["A1"]; c.value="แผนการเรียน ป.ตรี เศรษฐศาสตร์ ม.รามคำแหง — Quant+Finance/IB (v12 รวม GPAX — แก้บุพวิชา)"; c.font=FT; c.fill=NAVY; c.alignment=C; ws.row_dimensions[1].height=24
ws.merge_cells("A2:H2"); c=ws["A2"]; c.value="v12: แก้ MTH3611 PR=STA2003 (เดิมใส่ผิด) • ตัด C++ (COS2102) ออก • เพิ่ม STA2003 (แก้ทั้ง ECO2126 & MTH3611) • คง 168 นก./8 เทอม | ชีต GPAX=คำนวณเกรด, ชีต เทียบ ป.โท Top-U=โอกาสเรียนต่อ"; c.font=FNOTE; c.alignment=L; ws.row_dimensions[2].height=22
r=4
