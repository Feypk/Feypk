...
OUT = "/home/user/Feypk/Plan_RU_Econ_Quant_v7.xlsx"
...
FILL = {
    ...
    "new":   PatternFill("solid", fgColor="FFF2CC"),  # เหลือง = วิชาเพิ่มใหม่ v7
}
...
PLAN = [
 ("ปีที่ 1 / เทอม 1", 21, [
   ...
   ("ACC1103","การบัญชีการเงิน",3,"แกน econ","-","พื้นบัญชี → บุพวิชา FIN2101","econ"),
 ...
 ("ปีที่ 3 / เทอม 1", 21, [
   ...
   ("FIN2101","Business Finance (การเงินธุรกิจ)",3,"★ เพิ่มใหม่ v7 • เก็บเพิ่ม • แทน STA3301","ACC1103 (เช็กภาควิชา)","บุพวิชาจริงของ FIN3319/3209/3205","new"),
 ]),
 ("ปีที่ 3 / เทอม 2", 21, [
 ...
 ("ปีที่ 4 / เทอม 1", 21, [
   ...
   ("FIN3319","Fintech and Digital Assets",3,"FIN • algo/digital assets","FIN2101","✅ มี FIN2101 ในแผนแล้ว","fin"),
 ...
 ("ปีที่ 4 / เทอม 2", 21, [
   ...
   ("FIN3209","Securities Analysis",3,"FIN • valuation ภาคปฏิบัติ","FIN2101","✅ มี FIN2101 ในแผนแล้ว","fin"),
   ("FIN3205","Principles & Policies of Investment",3,"FIN • ฐานการลงทุน/พอร์ต","FIN2101","✅ มี FIN2101 ในแผนแล้ว","fin"),
...
wb = Workbook()
ws = wb.active
ws.title = "แผนรายเทอม v7"
ws.sheet_view.showGridLines = False

NC = 7
ws.merge_cells(start_row=1, start_column=1, end_row=1, end_column=NC)
c = ws.cell(1,1,"แผนการเรียน ป.ตรี เศรษฐศาสตร์ ม.รามคำแหง — สาย Quant (v7: 168 นก.)")
c.font = FONT_TITLE; c.fill = TITLE_FILL; c.alignment = CENTER
ws.row_dimensions[1].height = 24
ws.merge_cells(start_row=2, start_column=1, end_row=2, end_column=NC)
note = ("แก้จาก v6: +FIN2101 (ปี3/เทอม1) แทน STA3301 ที่ตัดออก → FIN2101 เป็นบุพวิชาจริงของ "
        "FIN3319/3209/3205 (เลิกต้อง 'ขอเทียบ') • รวมยังคง 168 นก. • โครงสร้างแกน 120 ไม่เปลี่ยน")
...
c = ws.cell(3,1,"ฟ้า=เศรษฐศาสตร์ | เขียว=คณิต–สถิติ–โปรแกรม | ส้ม=การเงิน (ECO/FIN) | เทา=ศึกษาทั่วไป | เหลือง=วิชาเพิ่มใหม่ v7 (FIN2101) | ⬅=ย้ายใน v5")
...
summ = [
 ...
 ("เก็บเพิ่ม (STEM + FIN + CS)","-","48","FIN2101 แทน STA3301"),
